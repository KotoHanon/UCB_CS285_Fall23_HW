...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            paths, envsteps_this_batch = utils.sample_trajectories(env=env, policy=actor, min_timesteps_per_batch=100, max_path_length=100)
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          random_indices = np.random.permutation(len(replay_buffer) - batch_size)[:batch_size]
